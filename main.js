...
async function connectionUpdate(update) {
  ...
  if (global.db.data == null) loadDatabase()
    if (connection === "open") {
        ...
        const infoMsg = `*Bot Telah Online*`;
    ...
    if (connection == 'close') {
        console.log(chalk.yellow(`🚩 Connection closed, please delete the folder sessions and rescan the QR code`));
    }
}
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '👋𝗛𝗲𝗹𝗹𝗼 @user\n\n    ✷⁠ 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 ✷\n⏤͟͟͞͞✧@subject\n\n▸ _"Group Di Lengkapi Oleh Bot"_\n▸ © ${namebot}'
